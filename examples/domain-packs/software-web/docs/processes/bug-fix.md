...
> Optional example process from the `software-web` domain pack.
...
Roles are declared in `examples/domain-packs/software-web/processes/bug-fix.yaml`; responsibility boundaries separate operator, primary agent, Director, Inspector, worker, and CLI tool duties.
