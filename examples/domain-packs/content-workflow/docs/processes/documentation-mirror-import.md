...
> Optional example process from the `content-workflow` domain pack.
...
Roles are declared in `examples/domain-packs/content-workflow/processes/documentation-mirror-import.yaml`; responsibility boundaries separate operator, primary agent, Director, Inspector, worker, and CLI tool duties.
