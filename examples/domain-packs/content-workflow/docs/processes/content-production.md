...
Roles are declared in `examples/domain-packs/content-workflow/processes/content-production.yaml`; responsibility boundaries separate operator, primary agent, Director, Inspector, worker, and CLI tool duties.
