...
python <processforge-root>/bin/pf.py task-create --project-root <project-root> --run minimal-run --id task-001-work --title "Do the work" --process software-feature-development --apply
...
python <processforge-root>/bin/pf.py task-create --project-root <project-root> --run minimal-run --id task-002-review --title "Review result" --process testing --apply
