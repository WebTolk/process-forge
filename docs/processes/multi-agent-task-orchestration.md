...
Roles are declared in `processes/core/multi-agent-task-orchestration.yaml`; responsibility boundaries separate operator, primary agent, Director, Inspector, worker, and CLI tool duties.
