...
Roles are declared in `processes/task-batch-execution.yaml`; responsibility boundaries separate operator, primary agent, Director, Inspector, worker, and CLI tool duties.
