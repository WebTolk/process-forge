...
Roles are declared in `processes/core/context-resolution.yaml`; responsibility boundaries separate operator, primary agent, Director, Inspector, worker, and CLI tool duties.
