...
Roles are declared in `processes/core/project-onboarding.yaml`; responsibility boundaries separate operator, primary agent, Director, Inspector, worker, and CLI tool duties.
