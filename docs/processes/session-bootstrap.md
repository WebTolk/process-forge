...
Roles are declared in `processes/core/session-bootstrap.yaml`; responsibility boundaries separate operator, primary agent, Director, Inspector, worker, and CLI tool duties.
