...
Roles are declared in `processes/platform-contract-install.yaml`; responsibility boundaries separate operator, primary agent, Director, Inspector, worker, and CLI tool duties.
