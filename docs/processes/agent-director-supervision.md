...
Roles are declared in `processes/core/agent-director-supervision.yaml`; responsibility boundaries separate operator, primary agent, Director, Inspector, worker, and CLI tool duties.
