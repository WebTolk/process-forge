...
Roles are declared in `processes/runtime-driver-registry.yaml`; responsibility boundaries separate operator, primary agent, Director, Inspector, worker, and CLI tool duties.
