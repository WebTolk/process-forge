...
Roles are declared in `processes/knowledge-resource-add.yaml`; responsibility boundaries separate operator, primary agent, Director, Inspector, worker, and CLI tool duties.
