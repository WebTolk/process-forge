...
Roles are declared in `processes/core/process-version-upgrade.yaml`; responsibility boundaries separate operator, primary agent, Director, Inspector, worker, and CLI tool duties.
