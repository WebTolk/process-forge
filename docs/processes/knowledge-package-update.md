...
Roles are declared in `processes/knowledge-package-update.yaml`; responsibility boundaries separate operator, primary agent, Director, Inspector, worker, and CLI tool duties.
