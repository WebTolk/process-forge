...
Roles are declared in `processes/core/workplace-initialization.yaml`; responsibility boundaries separate operator, primary agent, Director, Inspector, worker, and CLI tool duties.
