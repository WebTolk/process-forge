...
Roles are declared in `processes/core/platform-contract-authoring.yaml`; responsibility boundaries separate operator, primary agent, Director, Inspector, worker, and CLI tool duties.
