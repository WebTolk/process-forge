...
Текущая рабочая папка агента не задаёт роль в этой модели. Агент настройки
может быть запущен из корня дистрибутива, workplace, глобальной папки
конфигурации агента или любого другого каталога. Роли назначают только явные
аргументы команд и manifest-файлы.
