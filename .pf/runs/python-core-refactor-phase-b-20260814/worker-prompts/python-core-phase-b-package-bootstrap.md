...
- task_id: `python-core-phase-b-package-bootstrap`
- run_id: `python-core-refactor-phase-b-20260814`
- assignment: `.pf/assignments/python-core-phase-b-package-bootstrap.yaml`
- capsule: `.pf/contexts/assignment-capsules/python-core-phase-b-package-bootstrap.capsule.yaml`
- workspace_access_file: `.pf/runtime/agent-runs/python-core-refactor-phase-b-20260814/python-core-phase-b-package-bootstrap/workspace-access.json`
...
- `package-bootstrap-implementation` -> `.pf/artifacts/python-core-refactor-phase-b-20260814/package-bootstrap-report.md`
