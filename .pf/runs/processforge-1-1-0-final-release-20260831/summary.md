...
- `pf-1-1-0-final-release-audit-20260831`: `done` - Audited updater, release provenance, agent/human documentation, Runtime/MCP lifecycle, and Codex hook coupling; recorded bounded two-phase release design.
- `pf-1-1-0-final-release-implementation-20260831`: `done` - Implemented stable 1.1.0 update metadata contract, Garage-first docs/instructions, optional Codex hooks, and focused release smokes.
- `pf-1-1-0-final-release-assurance-20260831`: `done` - Completed source assurance: 183/185 checks passed; remaining failures are clean-Git/stale-dist release-delivery gates, with hosted MCP proof explicitly external.
