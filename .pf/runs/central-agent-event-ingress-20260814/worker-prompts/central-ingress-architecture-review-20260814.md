...
- task_id: `central-ingress-architecture-review-20260814`
- run_id: `central-agent-event-ingress-20260814`
- assignment: `.pf/assignments/central-ingress-architecture-review-20260814.yaml`
- capsule: `.pf/contexts/assignment-capsules/central-ingress-architecture-review-20260814.capsule.yaml`
- workspace_access_file: `.pf/runtime/agent-runs/central-agent-event-ingress-20260814/central-ingress-architecture-review-20260814/workspace-access.json`
...
- `central-event-ingress-design-review` -> `.pf/artifacts/central-agent-event-ingress-20260814/central-event-ingress-design-review.md`
