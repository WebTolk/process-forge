...
- task_id: `central-ingress-characterization-plan-20260814`
- run_id: `central-agent-event-ingress-20260814`
- assignment: `.pf/assignments/central-ingress-characterization-plan-20260814.yaml`
- capsule: `.pf/contexts/assignment-capsules/central-ingress-characterization-plan-20260814.capsule.yaml`
- workspace_access_file: `.pf/runtime/agent-runs/central-agent-event-ingress-20260814/central-ingress-characterization-plan-20260814/workspace-access.json`
...
- `characterization-and-validation-plan` -> `.pf/artifacts/central-agent-event-ingress-20260814/characterization-and-validation-plan.md`
