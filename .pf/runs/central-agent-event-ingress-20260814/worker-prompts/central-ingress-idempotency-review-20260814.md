...
- task_id: `central-ingress-idempotency-review-20260814`
- run_id: `central-agent-event-ingress-20260814`
- assignment: `.pf/assignments/central-ingress-idempotency-review-20260814.yaml`
- capsule: `.pf/contexts/assignment-capsules/central-ingress-idempotency-review-20260814.capsule.yaml`
- workspace_access_file: `.pf/runtime/agent-runs/central-agent-event-ingress-20260814/central-ingress-idempotency-review-20260814/workspace-access.json`
...
- `idempotency-and-replay-review` -> `.pf/artifacts/central-agent-event-ingress-20260814/idempotency-and-replay-review.md`
