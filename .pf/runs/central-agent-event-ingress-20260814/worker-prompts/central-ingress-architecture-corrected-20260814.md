...
- task_id: `central-ingress-architecture-corrected-20260814`
- run_id: `central-agent-event-ingress-20260814`
- assignment: `.pf/assignments/central-ingress-architecture-corrected-20260814.yaml`
- capsule: `.pf/contexts/assignment-capsules/central-ingress-architecture-corrected-20260814.capsule.yaml`
- workspace_access_file: `.pf/runtime/agent-runs/central-agent-event-ingress-20260814/central-ingress-architecture-corrected-20260814/workspace-access.json`
