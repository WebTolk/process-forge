...
Objective:
Coordinate worker outputs for run `r02-release-command-review-20260911`.

Current status:
Initial worker assignments, capsules, and launch prompts were generated.

Input artifacts:
- .pf/runs/r02-release-command-review-20260911/orchestrator-plan.yaml
- .pf/runs/r02-release-command-review-20260911/orchestration-summary.md

Files changed:
- .pf/runs/r02-release-command-review-20260911/
- .pf/assignments/
...
Required checks:
- `python .pf/runtime/bin/pf.py run-doctor --project-root . --run r02-release-command-review-20260911`
