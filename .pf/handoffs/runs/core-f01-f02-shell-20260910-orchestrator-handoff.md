...
Objective:
Coordinate worker outputs for run `core-f01-f02-shell-20260910`.

Current status:
Initial worker assignments, capsules, and launch prompts were generated.

Input artifacts:
- .pf/runs/core-f01-f02-shell-20260910/orchestrator-plan.yaml
- .pf/runs/core-f01-f02-shell-20260910/orchestration-summary.md

Files changed:
- .pf/runs/core-f01-f02-shell-20260910/
- .pf/assignments/
...
Required checks:
- `python .pf/runtime/bin/pf.py run-doctor --project-root . --run core-f01-f02-shell-20260910`
