...
Objective:
Coordinate worker outputs for run `codebase-audit-shell-20260910`.

Current status:
Initial worker assignments, capsules, and launch prompts were generated.

Input artifacts:
- .pf/runs/codebase-audit-shell-20260910/orchestrator-plan.yaml
- .pf/runs/codebase-audit-shell-20260910/orchestration-summary.md

Files changed:
- .pf/runs/codebase-audit-shell-20260910/
- .pf/assignments/
...
Required checks:
- `python .pf/runtime/bin/pf.py run-doctor --project-root . --run codebase-audit-shell-20260910`
