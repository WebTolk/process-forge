...
Objective:
Coordinate worker outputs for run `core-a01-a11-wave1-20260911`.

Current status:
Initial worker assignments, capsules, and launch prompts were generated.

Input artifacts:
- .pf/runs/core-a01-a11-wave1-20260911/orchestrator-plan.yaml
- .pf/runs/core-a01-a11-wave1-20260911/orchestration-summary.md

Files changed:
- .pf/runs/core-a01-a11-wave1-20260911/
- .pf/assignments/
...
Required checks:
- `python .pf/runtime/bin/pf.py run-doctor --project-root . --run core-a01-a11-wave1-20260911`
