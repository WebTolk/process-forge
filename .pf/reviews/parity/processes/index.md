...
| `bug-fix` | WARN | `processes/bug-fix.yaml` | `.pf/reviews/parity/processes/bug-fix-parity.md` |
| `content-production` | WARN | `processes/content-production.yaml` | `.pf/reviews/parity/processes/content-production-parity.md` |
| `context-resolution` | WARN | `processes/context-resolution.yaml` | `.pf/reviews/parity/processes/context-resolution-parity.md` |
| `documentation-mirror-import` | WARN | `processes/documentation-mirror-import.yaml` | `.pf/reviews/parity/processes/documentation-mirror-import-parity.md` |
| `guided-workplace-setup` | PASS | `processes/guided-workplace-setup.yaml` | `.pf/reviews/parity/processes/guided-workplace-setup-parity.md` |
| `knowledge-package-authoring` | WARN | `processes/knowledge-package-authoring.yaml` | `.pf/reviews/parity/processes/knowledge-package-authoring-parity.md` |
| `knowledge-package-improvement` | WARN | `processes/knowledge-package-improvement.yaml` | `.pf/reviews/parity/processes/knowledge-package-improvement-parity.md` |
| `knowledge-package-update` | WARN | `processes/knowledge-package-update.yaml` | `.pf/reviews/parity/processes/knowledge-package-update-parity.md` |
| `knowledge-resource-add` | WARN | `processes/knowledge-resource-add.yaml` | `.pf/reviews/parity/processes/knowledge-resource-add-parity.md` |
| `mcp-register` | WARN | `processes/mcp-register.yaml` | `.pf/reviews/parity/processes/mcp-register-parity.md` |
| `multi-agent-task-orchestration` | PASS | `processes/multi-agent-task-orchestration.yaml` | `.pf/reviews/parity/processes/multi-agent-task-orchestration-parity.md` |
...
| `process-supervisor` | PASS | `processes/process-supervisor.yaml` | `.pf/reviews/parity/processes/process-supervisor-parity.md` |
...
| `workplace-initialization` | WARN | `processes/workplace-initialization.yaml` | `.pf/reviews/parity/processes/workplace-initialization-parity.md` |
