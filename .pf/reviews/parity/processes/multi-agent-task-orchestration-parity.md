# Process Parity: multi-agent-task-orchestration
...
- Path: `processes/multi-agent-task-orchestration.yaml`
- Process id: `multi-agent-task-orchestration`

## Authoring Coverage

| Area | Status | Notes |
|---|---|---|
| logic_review | PASS | 47 checks |
