...
class ProcessExecutionService:
        ...
        *,
        ...
        with self._run_lock(str(run.get("id") or "")):
            ...
            if next_stage_id:
                ...
                self._atomic_yaml(self._completion_intent_path(str(run["id"])), intent)
    ...
    def _build_completion_intent(
        ...
        *,
        ...
        history = final_assignment.get("stage_history") if isinstance(final_assignment.get("stage_history"), list) else []
    ...
    def _validate_completion_intent(
        ...
        if final_run.get("status") not in TERMINAL_RUN_STATUSES or final_assignment.get("status") not in TERMINAL_ASSIGNMENT_STATUSES:
