...
Roles are declared in `packs/official/verification/processes/testing.yaml`; responsibility boundaries separate operator, primary agent, Director, Inspector, worker, and CLI tool duties.
