...
> Production process from the official bundled
...
Roles are declared in `packs/official/content-workflow/processes/documentation-mirror-import.yaml`; responsibility boundaries separate operator, primary agent, Director, Inspector, worker, and CLI tool duties.
