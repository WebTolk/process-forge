...
Roles are declared in `packs/official/content-workflow/processes/content-production.yaml`; responsibility boundaries separate operator, primary agent, Director, Inspector, worker, and CLI tool duties.
