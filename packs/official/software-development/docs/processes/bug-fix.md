...
Roles are declared in `packs/official/software-development/processes/bug-fix.yaml`; responsibility boundaries separate operator, primary agent, Director, Inspector, worker, and CLI tool duties.
