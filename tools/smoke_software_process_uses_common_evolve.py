...
def main() -> int:
    pack_root = ROOT / "examples" / "domain-packs"
    process = load_yaml(pack_root / "software-web" / "processes" / "software-feature-development.yaml")
    ...
    testing_targets = set(load_yaml(pack_root / "verification-workflow" / "processes" / "testing.yaml").get("evolve", {}).get("candidate_targets") or [])
